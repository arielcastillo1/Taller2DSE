...
FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Empleado con ID " + this.empleado.getId() + "Agregado" ));
...
FacesContext.getCurrentInstance().addMessage(null,new FacesMessage("Cliente con ID " + this.empleado.getId() + "Eliminado" ));
}
FacesContext.getCurrentInstance().addMessage(null,new FacesMessage("Cliente con ID " + this.empleado.getId() + " NOencontrado" ));
this.empleado = new Datosempleados();
return "Empleado";
}
...
DatosEmpleadosDAO empleadoDao = new DatosEmpleadosDAO();
Datosempleados obtempleado = empleadoDao.getEmpleadoID(this.empleado.getId());
...
FacesContext.getCurrentInstance().addMessage(null,new FacesMessage("Empleado con ID " + this.empleado.getId() + " NO encontrado" ));
}
this.empleado = new Datosempleados();
return "Empleado";
}
